...
## How Walmart Actually Does It (From Their Engineering Blog)

### Architecture: Domain-Driven Bounded Contexts

Walmart does NOT have a single "transactability engine." They use **DDD bounded contexts** where each domain owns its own eligibility dimension:
...
### Scope: The Part Walmart Won't Show You

Walmart's compliance/regulatory layer is the **most opaque part** of their architecture — zero public blog posts about alcohol rules, hazmat shipping, age-restricted items, or state-by-state regulations. We're building that.
...
**Phase 4: Polish + Interview-Ready (Day 7)**
...
### Killer Features (What Makes This Interview-Worthy)
