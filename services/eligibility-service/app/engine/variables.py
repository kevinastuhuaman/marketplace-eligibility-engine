...
def build_variables(
    ...
    variables = {
        ...
        "seller_in_stock_rate": float(seller_data["in_stock_rate"]) if seller_data and seller_data.get("in_stock_rate") is not None else None,
        "seller_cancellation_rate": float(seller_data["cancellation_rate"]) if seller_data and seller_data.get("cancellation_rate") is not None else None,
        "seller_valid_tracking_rate": float(seller_data["valid_tracking_rate"]) if seller_data and seller_data.get("valid_tracking_rate") is not None else None,
        "seller_response_rate": float(seller_data["seller_response_rate"]) if seller_data and seller_data.get("seller_response_rate") is not None else None,
        "seller_return_rate": float(seller_data["return_rate"]) if seller_data and seller_data.get("return_rate") is not None else None,
        "seller_item_not_received_rate": float(seller_data["item_not_received_rate"]) if seller_data and seller_data.get("item_not_received_rate") is not None else None,
        "seller_negative_feedback_rate": float(seller_data["negative_feedback_rate"]) if seller_data and seller_data.get("negative_feedback_rate") is not None else None,
